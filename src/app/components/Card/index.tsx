...
const Card = ({ filme }: Props) => {
  ...
  return (
    <Link
      href={`/filmes/${id}`}
      className="group block bg-[#0e1420] border border-[#1a2e4a] rounded-lg overflow-hidden transition-all duration-200 hover:border-[#2451b8] hover:shadow-[0_8px_32px_rgba(59,111,212,0.15)]"
    >
      {/* Foto */}
      ...
      <div className="p-3">
        ...
        {overview && (
          <p className="mt-1 text-[#93b3ea] text-xs leading-relaxed line-clamp-2">
            {overview}
          </p>
        )}
      </div>
